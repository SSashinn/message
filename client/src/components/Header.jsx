  ...
  return (
    <header className="header">
      <div className="friend">
        ...
        <Link to={'/online'}><p className="header-word">All</p></Link> 
        <Link to={'/online'}><p className="header-word">Pending</p></Link> 
        <Link to={'/online'}><p className="header-word">Blocked</p></Link> 
